    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2000, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Alice", "Smith" },
                    { 2, 2, new DateTime(2001, 5, 23, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bob", "Johnson" },
                    { 3, 3, new DateTime(1999, 11, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Charlie", "Brown" }
                });
